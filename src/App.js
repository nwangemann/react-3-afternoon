...
import NavPrevious from './NavPrevious'
...
class App extends Component {
  constructor(){
    ...
    indexNext = () => {
      ...
      this.updateDisplay(this.state.currentIndex)
    } else {
      this.setState({
        currentIndex: 25
      })
  ...
  updateDisplay(val){
        this.setState({
        name: data[val].name.first + ' ' + data[val].name.last,
        location: data[val].city + ', ' + data[val].country,
        title: data[val].title,
        employer: data[val].employer,
        favoriteMovies: data[val].favoriteMovies,
      })
  }
  ...
  render(){
    ...
    <div className="App">
      ...
      />
      <Card 
        updateDisplay={() => this.updateDisplay(this.state.currentIndex)}
      ...
      <div className="flexLeft">
        <NavPrevious
        indexPrevious={this.indexPrevious}
      />
      </div>
      </div>
    </div>
